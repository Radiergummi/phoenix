 ...
 * @description Provides a Reader that can read paths from the local file system. It supports
 * globbed patterns, supplied as a single glob string or an array of those.
 *
...
class FileSystemReader extends Reader {
   ...
   * reads a single file
   *
   * @param  {string}           path filesystem path for the file
